            ...
            .onTapGesture {
                if((player.currentItem == nil)) {
                    ...
                    self.playerController.playerWrapper.setSource(TivioPlayerSource(
                        channel: "prima hd",
                        mode: "timeshift",
                        uri: "https://ts0-pl.as.4net.tv/at/hls/master/vod_703_h264hd12.m3u8?start=1645279740&end=1645286700&device=88a292a41acd5b6035aa1ebfb067057c&stream_profiles=h264hd12&backoffice=testing",
